...
namespace CarCareTracker.Helper
{
    ...
    public static class StaticHelper
    {
        ...
        public const string DefaultLogoPath = "/defaults/driveledger_logo.png";
        public const string DefaultSmallLogoPath = "/defaults/driveledger_logo_small.png";
        ...
        public const string ReleasePath = "https://api.github.com/repos/KronigDev/DriveLedger/releases/latest";
        public const string TranslationDirectoryPath = $"{TranslationPath}/directory.json";
        public const string ReportNote = "Report generated by DriveLedger, a Free and Open Source Vehicle Maintenance Tracker based on LubeLogger";
        ...
        {
            return new List<string> { "#4a9e2e", "#63ac29", "#84bb23", "#acc91b", "#d7d211", "#e6b406", "#ea9306", "#e57a12", "#e0651d", "#db5427", "#d54631", "#d03b3b" };
        }
        ...
        public static void InitMessage(IConfiguration config)
        {
            ...
            {
                Console.WriteLine("WARNING: No Locale or Culture Configured for DriveLedger, Check Environment Variables");
            }
