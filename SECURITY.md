DriveLedger is not designed to be deployed in serious enterprise applications. Authentication should be enabled for public(Internet-facing) deployments.
...
- Your public-facing instance of DriveLedger without Authentication was defaced by malicious actors.
- A malicious actor has breached your server, accessed your postgres database and reversed the password hashes of DriveLedger users.
